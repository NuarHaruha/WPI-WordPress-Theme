...
define('WPI_IS_IMAGE_READY', (file_exists(WPI_IMG_DIR.'wpi.png')) );

/**
 * check template htacess file
 * WP 2.8+ strip all .htacess file extracted from archive
 * since r311
 */
define('WPI_IS_HTACCESS', (file_exists(WPI_DIR.'.htaccess'))  );
