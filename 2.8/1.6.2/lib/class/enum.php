...
{	
	 ...
	 * @since 1.6.2
	 */
	 const DOC_PUB_IMAGE_URL = 'http://wp-istalker.googlecode.com/files/wpi-chrome-images.zip';
	 ...
	 * @since rv311
	 */
	 const DOC_PUB_HTACCESS_URL = 'http://wp-istalker.googlecode.com/files/.htaccess';	 
	 //const DOC_PUB_HTACCESS_URL = 'http://wp-istalker.googlecode.com/svn/branches/WordPress/2.7/1.6.2/.htaccess';
